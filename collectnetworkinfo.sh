...
## Output file ##
OUTPUT="cluster-network.$(date +'%d-%m-%y').info.txt"

## Email info to?? ##
SUPPORT_ID="m3n4xt@slpm.siemens.com"
...
dump_info() {
	...
	write_header "Memory Stats"
	df -h | xargs | awk '{print "Free/total disk: " $11 " / " $9}' -s >$OUTPUT
